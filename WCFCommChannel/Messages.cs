 ...
 *  Function        :       Defines the structure of message to be transmitted over WCF Service
 ...
 * Package Operations:
 * -------------------
 * Messages defines the structure of the message transmitted over the WCF Communication
 * 
 * Public Interface
 * ----------------
...
{ 
    // MessageContract to transfer the files across the WCF Communication
    [MessageContract]
    ...
    // Contains the structure for the message to be transmitted and method showMsg() to display the content
    [Serializable]
    ...
    // showMsg() method displays the content of the Message
    ...
    static void Main(string[] args)
    {
      ...
      msg.author = "JeganGopalakrishnan";
